    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="d-flex align-items-center">
                    <img src="{{ asset('storage/img/logo/Steam_icon.png') }}" alt="Logo" class="logo me-3" style="max-width: 50px;">
            ...
            <div class="col-md-4">
                ...
                <p class="fs-14">EASYIN is a platform that connects event organizers with participants, providing an easy way to discover and join various events.</p>
            </div>
            <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-10 text-center">
                <p class="fs-12 mb-0" style="color: #888;">&copy; {{ date('Y') }} <span class="text-title" style="color: #fd5e53;">EASYIN</span> - All Rights Reserved</p>
            </div>
        </div>
    </div>
</footer>
