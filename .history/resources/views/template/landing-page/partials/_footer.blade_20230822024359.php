<footer class="bg-dark text-white py-4 {{ request()->is('login') || request()->is('register') ? 'footer-fixed' : '' }}">
    ...
    <style>
       .footer {
        ...
        bottom: 0;
        width: 100%;
        padding: 20px 0; /* Atur sesuai dengan kebutuhan */
        background-color: #343a40; /* Ganti warna sesuai kebutuhan */
    }
    ...
    /* Gaya tambahan untuk mengatur margin bawah konten */
    .content {
        margin-bottom: 100px; /* Atur sesuai tinggi footer */
        position: relative;
    }
    </style>
