            ...
            <div class="card-body">
               <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item d-flex justify-content-between pl-0 align-items-center">
                     ...
                     @if($tiket_gratis)
                        <div>
                           <a href="{{ url('/dashboard/acara/'.$acara->id.'/jenis-tiket?jenis=gratis') }}" class="btn btn-sm btn-secondary">Lihat Tiket ({{ $tiket_gratis->tiket_count }})</a>
                           <button class="btn btn-sm btn-danger">Hapus</button>
                        </div>
                     @else
                        <small class="text-muted">Belum ada, <a href="#" data-type="Gratis" class="btn-modal-jenis-tiket">tambah sekarang</a></small>
                     @endif
                  </li>
                  <li class="list-group-item d-flex justify-content-between pl-0 align-items-center">
                     <span>Berbayar</span>
                     @if($tiket_berbayar)
                        <div>
                           <a href="{{ url('/dashboard/acara/'.$acara->id.'/jenis-tiket?jenis=berbayar') }}" class="btn btn-sm btn-secondary">Lihat Tiket ({{ $tiket_berbayar->tiket_count }})</a>
                           <button class="btn btn-sm btn-danger">Hapus</button>
                        </div>
                     @else
                        <small class="text-muted">Belum ada, <a href="#" data-type="Berbayar" class="btn-modal-jenis-tiket">tambah sekarang</a></small>
                     @endif
                  </li>
               </ul>
            </div>
         ...
         <div class="card shadow mb-4">
            <div class="card-header py-3">
               <div class="d-flex justify-content-between align-items-center">
                  <h6 class="m-0 font-weight-bold text-primary">Tiket {{ ucwords($jenis_tiket) }}</h6>
                  <a href="#" data-toggle="modal" data-target="#modalTiket" class="btn btn-sm btn-primary btn-modal-tiket">Tambah Data</a>
               </div>
            </div>
            <div class="card-body">
            ...
            <form action="{{ route('dashboard.jenis-tiket.store', $acara->id) }}" method="POST">
               ...
               <div class="modal-body">
                  ...
                  <div class="form-group">
                     ...
                     <textarea class="form-control" id="keuntungan" name="keuntungan" rows="5"></textarea>
                  </div>
               </div>
            ...
            <form action="{{ route('dashboard.tiket.store', $acara->id) }}" method="POST">
               ...
               <div class="modal-body">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" id="tier" name="tier" placeholder="opsional">
                     <small class="text-muted">Contoh: VIP, Reguler</small>
                  </div>
                  <div class="form-group">
                     <label for="kursi">Nomor Kursi</label>
                     <input type="text" class="form-control" id="kursi" name="kursi" placeholder="opsional">
